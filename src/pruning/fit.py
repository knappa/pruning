    ...
    for options in ["L-BFGS-B-Medium", "L-BFGS-B-Heavy"]:
        ...
        try:
            ...
            res = minimize(
                ...
                method="L-BFGS-B",
                bounds=[(0.0, np.maximum(min_branch_length / 2, 1e-10))]
...
def fit_factored_model(
    *,
    ...
    :param rate_params:
    :param log_freq_params:
    :param mat_neg_log_likelihood:
    :param pat_neg_log_likelihood:
    :param joint_neg_log_likelihood:
    :param rate_constraint:
    :param ploidy:
    :param final_rp_norm:
    :param log:
    ...
    try:
        ...
        # belt and suspenders for the constraint
        mat_branch_lengths[0] = 0.0
        mat_branch_lengths[1:] = np.clip(np.nan_to_num(res.x[1:]), min_branch_length, np.inf)
    except ValueError:
        pass
    ...
    try:
        ...
        # belt and suspenders for the constraint
        pat_branch_lengths[0] = 0.0
        pat_branch_lengths[1:] = np.clip(np.nan_to_num(res.x[1:]), min_branch_length, np.inf)
    except ValueError:
        pass
...
def scale_params(
    *,
    ...
    :param final_rp_norm:
    :param log_freq_params:
    :param ploidy: ignored if final_rp_norm is True
    :param rate_constraint:
    :return:
    """
